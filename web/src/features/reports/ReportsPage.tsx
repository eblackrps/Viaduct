...
import type { MigrationMeta, SnapshotMeta } from "../../types";
    ...
    <div className="space-y-6">
      ...
      {(migrations.length > 0 || snapshots.length > 0) && (
        <section className="grid gap-5 xl:grid-cols-[1.1fr_0.9fr]">
          <MigrationHistory migrations={migrations} loading={loading} error={migrationError} />
          <DiscoverySnapshotsPanel snapshots={snapshots} loading={loading} error={snapshotError} />
        </section>
      )}
    </div>
  );
