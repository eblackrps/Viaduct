...
The current release-facing screenshots are aligned with the packaged operator shell, the local `viaduct start` flow, the runtime bootstrap path, and the current `v2.3.0` release surface.
