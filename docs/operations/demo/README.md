...
The current release-facing screenshots are aligned with the packaged operator shell, the local `viaduct start` flow, the Get started sign-in path, and the current `v3.1.1` release surface.
