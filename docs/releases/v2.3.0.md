...
Viaduct v2.3.0 is a dashboard finish-and-release pass. It does not change the backend contract, but it materially upgrades the operator UI, interaction quality, accessibility, responsive behavior, and release-facing collateral.
...
- Refreshed the major operator surfaces, including the auth bootstrap, pilot workspace flow, inventory assessment, migration workflow, lifecycle pages, policy views, drift views, reports, settings, and the shared shell.
...
- Existing pilot workspace, migration, and reporting flows remain compatible; this release is focused on frontend polish, correctness, and release hygiene.

## Verification

This release was validated through the canonical gate and targeted frontend checks:
...
- [Pilot workspace](../operations/demo/screenshots/pilot-workspace.png)
