...
- Local evaluation: run `viaduct start`, open `http://127.0.0.1:8080`, choose `Start local session`, create an assessment, discover, inspect, simulate, save a plan, and export a report.
