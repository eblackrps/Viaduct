...
- Unix socket-style listener addresses are not considered loopback-equivalent for the local operator session flow, same-origin checks, or direct-loopback trust decisions.
